...
const DteController = require('../Controller/dte.controller')
const {validaDteEsquema} = require('../Validators/dte.validators')
const {validateToken} =require('../Validators/token.validator')

router.post(
    '/factura',
    [validateToken,validaDteEsquema],
    //  #swagger.tags = ['DTE']
    ...
    */
    DteController.generateDte
)

router.get('/factura',[validateToken], (req, res) => {
